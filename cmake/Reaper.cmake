...
# NOTE: call this macro AFTER target_sources() calls
...
macro(reaper_configure_coverage target)
    if(REAPER_BUILD_COVERAGE_INFO)
        ...
        elseif(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX)
            target_compile_options(${target} PRIVATE ${REAPER_GCC_COVERAGE_FLAGS})
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
            target_compile_options(${target} PRIVATE ${REAPER_CLANG_COVERAGE_FLAGS})
        endif()
    endif()
endmacro()
...
macro(reaper_add_tests library testfiles)
    if(REAPER_BUILD_TESTS)
        ...
        target_link_libraries(${REAPER_TEST_BIN} doctest ${library})
