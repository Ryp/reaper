...
void OpenGLRenderer::render()
{
    ...
    try {
        ...
        bloom_test(ctx, controller, /*reaper::getExecutablePath(av[0]) +*/ std::string("../rc/"));
        hdr_test(ctx, controller, /*reaper::getExecutablePath(av[0]) +*/ std::string("../rc/"));
        controller.destroy();
    }
