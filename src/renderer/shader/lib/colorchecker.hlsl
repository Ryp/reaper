...
static const float3 mcbeth_19_White         = float3(0xf3, 0xf3, 0xf3) / 255.f;
static const float3 mcbeth_20_Neutral       = float3(0xc8, 0xc8, 0xc8) / 255.f;
static const float3 mcbeth_21_Neutral       = float3(0xa0, 0xa0, 0xa0) / 255.f;
static const float3 mcbeth_22_Neutral       = float3(0x7a, 0x7a, 0x7a) / 255.f;
static const float3 mcbeth_23_Neutral       = float3(0x55, 0x55, 0x55) / 255.f;
static const float3 mcbeth_24_Black         = float3(0x34, 0x34, 0x34) / 255.f;
