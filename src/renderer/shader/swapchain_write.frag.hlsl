...
float3 apply_tonemapping_operator(float3 color_scene_nits, float min_nits, float max_nits)
{
    float3 tonemapped_color = float3(
        tonemapping_gran_turismo_2017(color_scene_nits.r, min_nits, max_nits),
        tonemapping_gran_turismo_2017(color_scene_nits.g, min_nits, max_nits),
        tonemapping_gran_turismo_2017(color_scene_nits.b, min_nits, max_nits)
    );
