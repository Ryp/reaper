...
namespace Reaper
{
    ...
    void vulkan_test(ReaperRoot& root, VulkanBackend& backend)
    {
        ...
        log_debug(root, "- image memory requirements: size = {}, alignment = {}, types = {:#b}",
        ...
        // back with da memory
        VkMemoryAllocateInfo memAllocInfo = {VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO, nullptr, allocSize,
                                             memoryTypeIndex};
