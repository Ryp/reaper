...
REAPER_VK_INSTANCE_LEVEL_FUNCTION(vkSetDebugUtilsObjectNameEXT)
...
REAPER_VK_INSTANCE_LEVEL_FUNCTION(vkCmdEndDebugUtilsLabelEXT)
...
REAPER_VK_INSTANCE_LEVEL_FUNCTION(vkQueueEndDebugUtilsLabelEXT)
