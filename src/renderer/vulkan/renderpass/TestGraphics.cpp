...
void backend_debug_ui(VulkanBackend& backend)
{
    ...
    {
        auto swapchain_format = backend.presentInfo.swapchain_format;
        ImGui::Text("Swapchain info:");
        ImGui::Text("format = %s", vk_to_string(swapchain_format.vk_format));
        ImGui::Text("colorspace = %s", vk_to_string(swapchain_format.vk_color_space));
        ImGui::Text("view format = %s", vk_to_string(swapchain_format.vk_view_format));
        ImGui::BeginDisabled();
        ImGui::Checkbox("HDR Swapchain", &swapchain_format.is_hdr);
        ImGui::EndDisabled();
