...

    {
        ...
        visibility_gbuffer.gbuffer_rt0 = try builder.createTexture(
            ...
            gpu_texture_properties.defaultTextureProperties(
                ...
                render_extent.height,
                gbuffer_rt0_format,
                // color_attachment is for the optional raster G-buffer pass,
                // which writes these same targets as an alternative producer.
                .{ .sampled = true, .storage = true, .color_attachment = true },
            ),
            compute_write,
            &.{},
        );
